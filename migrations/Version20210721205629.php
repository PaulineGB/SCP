 ...
 */
final class Version20210721205629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE story (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, number INT NOT NULL, is_validated TINYINT(1) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_EB5604383DA5256D (image_id), INDEX IDX_EB560438A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
